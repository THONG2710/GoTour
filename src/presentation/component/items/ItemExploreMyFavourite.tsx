...
const ItemExploreMyFavourite: React.FC<ItemExploreMyFavouriteProps> = (props) => {
    ...
    return (
        ...
        <View style={styles.container}>
            <View>
<<<<<<<< HEAD:src/presentation/container/MyFavourite/ItemMyFavourite/ItemExploreMyFavourite.tsx
                <Image style={styles.imageAddress} source={require('../../../resource/assets/images/slide4.png')}></Image>
========
                <Image style={styles.imageAddress} source={require('../../resource/assets/images/slide4.png')}></Image>
>>>>>>>> thong:src/presentation/component/items/ItemExploreMyFavourite.tsx
            </View>
            <View>
